...
import { ClientOrderFormData, mapFormToAddDto, mapFormToUpdateDto } from "@/types/orders/ClientOrderTypes"
...
export default function ClientOrderModal ({
    ...
    useEffect(() => {
        ...
        reset({
            label: order.label,
            assignedUserIds: order.assignedUsers.map(assignedUser => (assignedUser.id)),
