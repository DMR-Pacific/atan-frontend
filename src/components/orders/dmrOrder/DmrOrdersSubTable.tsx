...
export default function DmrOrdersSubTable() {
  const { subDmrOrderIds, handleOrderCheck, isSelectDisabled, warnUnlink } =
    useDmrOrdersSubTableContext();
  ...
  const isDmrOrderRowSelectDisabled = isSelectDisabled || !isEditAllowed
  return (
    <>
      <div
      // className='py-4 pr-4'
        ...
        <div className="pb- rounded-b-lg">
          {subDmrOrderIds.map((subDmrOrderId, i) => (
            <DmrOrderRow
              ...
              isSelectDisabled={isDmrOrderRowSelectDisabled}
